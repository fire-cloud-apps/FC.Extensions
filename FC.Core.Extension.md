...
- [PropertyEquals](#T-FC-Core-Extension-GenericHandlers-PropertyEquals 'FC.Core.Extension.GenericHandlers.PropertyEquals')
  - [IsPropertiesEquals\`\`1(self,to,ignore)](#M-FC-Core-Extension-GenericHandlers-PropertyEquals-IsPropertiesEquals``1-``0,``0,System-String[]- 'FC.Core.Extension.GenericHandlers.PropertyEquals.IsPropertiesEquals``1(``0,``0,System.String[])')
...
<a name='M-FC-Core-Extension-GenericHandlers-PropertyEquals-IsPropertiesEquals``1-``0,``0,System-String[]-'></a>
### IsPropertiesEquals\`\`1(self,to,ignore) `method`
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| self | [\`\`0](#T-``0 '``0') | Soruce Model? |
| to | [\`\`0](#T-``0 '``0') | Compare with? |
| ignore | [System.String[]](http://msdn.microsoft.com/query/dev14.query?appId=Dev14IDEF1&l=EN-US&k=k:System.String[] 'System.String[]') | Which property to ignore |

##### Generic Types

| Name | Description |
| ---- | ----------- |
| T | Model or Entity Type |
